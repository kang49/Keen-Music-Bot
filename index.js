...
client.on('ready', () => {
    ...
    client.user.setActivity(`kp link เพื่อเรียกเรานะ`, {
        type: "STREAMING",
...
function musicFunction() {
    ...
    const dcEmbed = new MessageEmbed()
        ...
        .addFields(
            { name: `${config.prefix}p [Name or Link]`, value: 'This command is used to request songs.', inline: false },
